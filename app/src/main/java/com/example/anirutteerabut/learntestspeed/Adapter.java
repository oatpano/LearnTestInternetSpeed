...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(ProgressionModel speedModel) {
            tvProgress.setText("" + speedModel.getProgressTotal());
            tvDownload.setText("" + speedModel.getDownloadSpeed());
            tvUpload.setText("" + speedModel.getUploadSpeed());
        }
    }
}
